        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.axios.get('/api/office/${this.$route.params.ed}').then(function (response) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this2.axios.put('/api/office/${this.$route.params.id}', _this2.office).then(function (response) {
                  _this2.$router.push({
                ...
                _c("input", {
                  ...
                  on: {
                    input: function ($event) {
                      ...
                      _vm.$set(_vm.office, "nombre_jefe", $event.target.value)
                    },
                  },
                }),
              ]),
              ...
              _c("input", {
                ...
                on: {
                  input: function ($event) {
                    ...
                    _vm.$set(_vm.office, "descripcion", $event.target.value)
                  },
                },
              }),
            ]),
