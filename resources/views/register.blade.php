...
@section('content')
	...
	<h1 class="text-5x1 text center pt-24">Register</h1>
	<form class="mt-4" method="POST" action="">

		@csrf

		<input type="text" class="border border-gray-200 rounded-md border-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Name" id="name" name="name">
		...
		<input type="password" class="border border-gray-200 rounded-md border-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" 
